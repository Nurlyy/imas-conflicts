...
$query_insert = "UPDATE v_40047_special.mvd_counts_stats SET smi_today=".$smi_day_count.", social_today=".$social_day_count.", smi_total=".$smi_total_count.", social_total=".$social_total_count." WHERE id=1";
