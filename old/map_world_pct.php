...
<body style="background: #252326;">
	...
	<div style="font-size: 30px; color: #FFF">География не определена: <?$count=$rk*100/$sum; echo round($count,1).'%';?></div>
</body>
...
$(function () {
    ...
    Highcharts.mapChart('container_maps_world', {
		...
		series: [{
			...
			dataLabels: {
				enabled: true,
				 format: '<span style="font-size: 16px;">{point.value:.2f}%</span>'
			},		
		}]
    });
});
