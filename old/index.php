...
foreach($statistic_date_array as $statistic_date){
		$date_grafics_1[] = '';
	if($statistic_date >= '2006-01-01' && $statistic_date <= date("Y-m-d")){
		// $dt=explode("-",$statistic_date);
		// $date_grafics_1[] = mktime(0,0,0,$dt[1],$dt[2],$dt[0]);
		// // if (in_array($dt[0], $date_grafics_1)) $date_grafics_1[] = '';
		// // else $date_grafics_1[] = $dt[0];
	}
}

/*$sql_statistic_day = mysqli_query($connect,"
	Select * From statistic_day order by date
")or die(mysqli_error($connect));
while($table_statistic_day = mysqli_fetch_array($sql_statistic_day)){	
	$statistic_day_array[] = $table_statistic_day;
	$statistic_date_day_array[] = $table_statistic_day['date'];
	$statistic_smi_day_array[] = $table_statistic_day['smi'];
	$statistic_social_day_array[] = $table_statistic_day['social'];
}
foreach($statistic_day_array as $statistic_day){
	$statistic_all_day_array[] = $statistic_day['smi'] + $statistic_day['social'];
}
$statistic_smi_day = implode(',', $statistic_smi_day_array);
$statistic_social_day = implode(',', $statistic_social_day_array);
$statistic_all_day = implode(',', $statistic_all_day_array);

foreach($statistic_date_day_array as $statistic_date_day){
	if($statistic_date_day >= '00:00' && $statistic_date_day <= '23:59'){
		$date_grafics_day[] = '';
	}
	
	if($statistic_date_day >= '00:00' && $statistic_date_day <= '03:59'){
		$date_grafics_day_1 = '00:00';
	}
	if($statistic_date_day >= '04:00' && $statistic_date_day <= '07:59'){
		$date_grafics_day_2 = '04:00';
	}
	if($statistic_date_day >= '08:00' && $statistic_date_day <= '11:59'){
		$date_grafics_day_3 = '08:00';
	}
	if($statistic_date_day >= '12:00' && $statistic_date_day <= '15:59'){
		$date_grafics_day_4 = '12:00';
	}
	if($statistic_date_day >= '16:00' && $statistic_date_day <= '19:59'){
		$date_grafics_day_5 = '16:00';
	}
	if($statistic_date_day >= '20:00' && $statistic_date_day <= '23:59'){
		$date_grafics_day_6 = '20:00';
	}
}
*/
$smi=array();
		...
		<div class="col-sm-9 col-md-9 col-lg-9 padding-0">
			<div class="col-sm-12 col-md-12 col-lg-12 padding-0">
				...
				<div class="col-sm-6 col-md-6 col-lg-6 padding-0 diagramm_1">
					...
					<?/*<div class="name_statistic_2014" style="margin-left: 30px">2006</div>
					<?
					...
					while($y<=date("Y")){
						...
						$interval = dt_diff($d1, $d2);
						$mrg=$interval*$p+100;?>
						<div class="name_statistic_<?=$y?>" style="margin-left: <?=$mrg?>px"><?=$y?></div>
						<?$y++;?>
					<?}?>*/?>
	...
	<div class="col-sm-12 col-md-12 col-lg-12 padding-0 ">
		...
		<div class="col-sm-6 col-md-6 col-lg-6 padding-0 maps_block">
			...
			<div class="col-sm-6 col-md-6 col-lg-6 padding-0 maps_world">
				<div class="title_block"><?echo ("Геодинамика публикаций<br> за месяц по миру");?></div><br>
			...
			<div class="col-sm-6 col-md-6 col-lg-6 padding-0 maps_rk">
				<div class="title_block"><?echo ("Геодинамика публикаций<br> за месяц по Казахстану");?></div><br>
			...
			<div class="col-sm-12 col-md-12 col-lg-12 padding-0 statistics_maps">
				<div class="col-sm-6 col-md-6 col-lg-6 padding-0">
					<div class="col-sm-6 col-md-6 col-lg-6">
						...
						echo $smi_resource_world = '27 493';
					...
					<div class="col-sm-9 col-md-9 col-lg-9">
						<table border="0" cellspacing="0">
							<tbody>
								<tr height="26px">
									<td width="26px">
										<img src="/images/vk.png" width="20px">
									</td>
									<td width="26px">
										<img src="/images/fb.ico" width="20px">
									</td>
									<td width="26px">
										<img src="/images/twitter.ico" width="20px">
									</td>
									<td width="26px">
										<img src="/images/instagram.ico" width="20px">
									</td>
									<td width="26px">
										<img src="/images/youtube.png" width="20px">
									</td>
									<td width="26px">
										<img src="/images/ok.ico" width="20px">
									</td>
									<td width="26px">
										<img src="/images/mm.ico" width="20px">
									</td>
									<td width="26px">
										<img src="/images/telegram.png" width="20px">
									</td>
									<td width="26px">
										<img src="/images/livejournal.png" width="20px">
									</td>
								</tr>
							</tbody>
						</table>
...
$(document).ready(function () {
	...
	Highcharts.chart('container_1', {
		...
		plotOptions: {
			...
			series: {
				lineWidth: 2,			
				pointStart: Date.UTC(2000, 01, 05, 0, 0, 0, 0),
				pointInterval: 60 * 1000  *  60 * 24 * 7,
				marker: {
					enabled: false
				}
			}
...
function update_table_smi(){	
	...
	setTimeout(function(){check_images_smi();setTimeout(function(){check_images_smi();},500);},100);
}
setInterval(function(){
	update_table_smi();
},1000*60);
...
function update_table_social(){	
	...
	setTimeout(function(){check_images();setTimeout(function(){check_images();},500);},100);
}
setInterval(function(){
		update_table_social();
},1000*60);
...
function check_images(){
	$('.res_logos').each(function(i,elem) {
		var w = elem.naturalWidth;
		if(w==0){
			$(elem).attr({src: '/images/no-logo.png'});
		}
		else{
			setTimeout(function(){
...
function check_images_smi(){
	$('.res_logos_smi').each(function(i,elem) {
		var w = elem.naturalWidth;
		if(w==0){
			$(elem).attr({src: '/images/no-logo.png'});
		}
